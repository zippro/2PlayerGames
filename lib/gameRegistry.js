...
export const GAMES = [
  ...
  },
  {
    id: 'chess',
    name: 'Chess',
    colors: ['#1B2838', '#FFD700'],
    gradient: 'linear-gradient(135deg, #1B2838 0%, #FFD700 100%)',
    modes: ['2p', '1p'],
    badge: 'NEW',
    description: 'The classic game of strategy! Checkmate your opponent to win.',
    howToPlay: [
      'Tap a piece to select it, then tap a highlighted square to move.',
      'Capture all your opponent\'s key pieces and trap their King.',
      'Put the King in checkmate — no escape possible — to win!',
    ],
  },
  {
    id: 'arrow-puzzle',
    name: 'Arrow Puzzle',
    colors: ['#1B2838', '#50C878'],
    gradient: 'linear-gradient(135deg, #1B2838 0%, #50C878 100%)',
    modes: ['2p', '1p'],
    badge: 'NEW',
    description: 'Tap arrows to clear the board! 60 levels of logical puzzle fun.',
    howToPlay: [
      'Tap an arrow to make it fly off the screen.',
      'An arrow can only escape if its path is clear — no other arrows blocking it!',
      'Find the right order to remove all arrows and clear the board.',
    ],
  },
];
